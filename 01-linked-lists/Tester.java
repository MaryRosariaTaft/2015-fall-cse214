public class Tester{
	...
	OrderedDoublePair[] arraySet1 = {c,b,b};
	UniLinkedList<OrderedDoublePair> llSet1;
	llSet1 = Point2D.fromArray(arraySet1);
	print(llSet1);

	OrderedDoublePair[] arraySet2 = {c,c,c,c};
	UniLinkedList<OrderedDoublePair> llSet2;
	llSet2 = Point2D.fromArray(arraySet2);
	print(llSet2);

	double[][] arraySet3 = {{07, 10}, {12, 31},  {07, 04}};
	...
	// print("centroid of set 1: " + Point2D.centroid(llSet1));
	// print("centroid of set 2: " + Point2D.centroid(llSet2));
	// print("centroid of set 3: " + Point2D.centroid(llSet3));

	// print("closest to origin in set 1: " + Point2D.smallest(llSet1));
	// print("closest to origin in set 2: " + Point2D.smallest(llSet2));
	// print("closest to origin in set 3: " + Point2D.smallest(llSet3));

	print("farthest from origin in set 1: " + Point2D.largest(llSet1));
	print("farthest from origin in set 2: " + Point2D.largest(llSet2));
	print("farthest from origin in set 3: " + Point2D.largest(llSet3));

	// print("llSet2: " + llSet2);
	// print("deduplicating llSet2");
	// llSet2.deduplicate();
	// print("updated llSet2: " + llSet2);
